...
const create_tipo_pago_dto_1 = require("./dto/create-tipo_pago.dto");
const update_tipo_pago_dto_1 = require("./dto/update-tipo_pago.dto");
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_tipo_pago_dto_1.UpdateTipoPagoDto]),
    __metadata("design:returntype", void 0)
...
TipoPagoController = __decorate([
    (0, swagger_1.ApiTags)('tipo_pago'),
    (0, common_1.Controller)('tipo-pago'),
    __metadata("design:paramtypes", [tipo_pago_service_1.TipoPagoService])
], TipoPagoController);
exports.TipoPagoController = TipoPagoController;
//# sourceMappingURL=tipo_pago.controller.js.map